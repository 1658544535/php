                        	...
                        	<tr>
                                ...
                                <td>
                                	<select name="prize_no" class="common-text">
                                		<option value="0"  <?php echo $rs->prize_no == 0 ? 'selected' : ''; ?> >未中奖（谢谢惠顾）</option>
                                		<option value="1"  <?php echo $rs->prize_no == 1 ? 'selected' : ''; ?> >微信红包</option>
                                		<option value="10" <?php echo $rs->prize_no == 10 ? 'selected' : ''; ?> >实体礼物</option>
                                	</select>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                	<select name="status" class="common-text">
                                		<option value="1" <?php echo $rs->status == 1 ? 'selected' : ''; ?> >开启</option>
                                		<option value="0" <?php echo $rs->status == 0 ? 'selected' : ''; ?> >关闭</option>
                                	</select>
                                </td>
                            </tr>
