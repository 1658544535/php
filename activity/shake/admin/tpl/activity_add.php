                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                	<input class="common-text" name="starttime" size="50" value="" type="text">
                            ...
                            <tr>
                                ...
                                <td>
                                	<input class="common-text" name="endtime" size="50" value="" type="text">
                            ...
                            <tr>
                                ...
                                <td><input class="common-text" name="playnum" size="50" value="" type="text"></td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>是否开启：</th>
                                <td>
                                	<input class="common-text" name="status" size="50" value="" type="text">
