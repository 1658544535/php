...
<section class="content">
    <div class="box">
        ...
        <form action="<?php echo url();?>" role="form" method="get">
            <input type="hidden" name="c" value="LuoDiYe" />
                ...
                <div class="row">
                    <div class="col-xs-2">
                        <div class="input-group">
                            ...
                            <input type="text" name="f" value="<?php echo $param['flag'];?>" class="form-control" />
                        </div>
                    </div>
                    <div class="col-xs-2">
                        <div class="input-group">
                            <div class="input-group-addon">IP</div>
                            <input type="text" name="ip" value="<?php echo $param['ip'];?>" class="form-control" />
                        </div>
                    </div>
                    <div class="col-xs-3">
                        <div class="input-group">
                            ...
                            <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                                ...
                                <?php foreach($list as $v){ ?>
                                    <tr role="row" class="odd">
                                        <td class="sorting_1"><?php echo $v->flag;?></td>
                                        <td class="sorting_1"><?php echo $v->ip;?></td>
