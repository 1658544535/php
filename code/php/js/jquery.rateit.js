...
(function ($) {
    ...
    $.fn.rateit = function (p1, p2) {
        ...
        return this.each(function () {
            ...
            var setSelection = function (value) {
                ...
                //changed by chendianwu
                $("#t_"+fld.attr("id")).html("&nbsp;&nbsp;"+fld.find("option:selected").text());
    ...
    //some default values.
    $.fn.rateit.defaults = { min: 0, max: 5, step: 0.5, starwidth: 32, starheight: 32, readonly: false, resetable: true, ispreset: false };
