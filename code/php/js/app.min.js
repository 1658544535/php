...
$(function() {
    ...
    $(document).on("pageInit", "#page-index", function(e, pageId, page) {
    	...
    	$(".index-class .swiper-wrapper>a").each(function(index, el) {
    		...
    		if(classId == 0){
    			var indexBoxHtml=bt('tpl_indexBox', {});
    			html += indexBoxHtml + '</div>';
    		}else{
    			var proBoxHtml=bt('tpl_proBox', {});
    			html += proBoxHtml + '</div>';
    		}
   ...
   //  	});
    ...
    $(document).on("pageInit", "#page-lottery", function(e, pageId, page) {
        ...
        fn_pull_tab(page, pageType, function(){
        	var index = $(".user-tabBar .tab-item").index($(".user-tabBar .tab-item.active"));
        	if(index == 0){
        		$(".lottery-rule").show();
        	}else{
        		$(".lottery-rule").hide();
