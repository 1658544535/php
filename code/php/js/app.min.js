					...
					if(res.code>0){
						if(classId == 0){
                            ...
                            if(subClassNum > maxSubClassNum) {
                                ...
                                $(".index-subClass ul").append('<li><a href="#"><div class="img"><img src="images/subClass-more.png" /></div><div class="txt">查看全部</div></a></li>');
                            }
	            		}
   ...
   //  	});
    ...
    $(document).on("pageInit", "#page-special-class", function(e, pageId, page) {
        ...
        $(document).on("click","a",function(){
        	if($(this).parents(".special-item").length>0){
        		...
        		localStorage.specialsId = $(".special-class .swiper-wrapper>a").eq(0).attr("data-id");
        	}
        });
        ...
        $(".class-two").on("scroll", function(){
            ...
            for(var i=0; i<class2Arr.length; i++){
                if(aTop >= maxScroll){
                    ...
                    return false;
                }else if(aTop > 0 && aTop < class2Arr[0]){
    ...
    $(document).on("pageInit", "#page-classGood", function(e, pageId, page) {
        ...
        $(".class-nav .show>li").each(function(index, el) {
            popHtml += '<li data-type="1"><a>1234</a></li>';
        });
...
function fn_pull_tab(page, index, fn){
    ...
    $(".user-tab li").on('click', function() {
    	...
    	if(pageId=="page-orderList" || pageId=="page-myGroup" || pageId=="page-guess" || pageId=="page-afterSales"){
