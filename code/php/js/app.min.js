        ...
        function getData(index_page, type, url){
        	$.ajax({
            	...
            	success: function(res){
		            	...
		            	case 'class':
		            		...
		            		for(var i=0; i<res.data.proList.listData.length; i++){
			            		html += '<li><a href="'+ res.data.proList.listData[i]["id"] +'">'
			                         +       '<div class="img"><img src="'+ res.data.proList.listData[i]["imgSrc"] +'" /></div>'
			                         +       '<div class="name">'
			                         +           '<span class="num">'+ res.data.proList.listData[i]["num"] +'人团</span>'+ res.data.proList.listData[i]["name"]
			                         +       '</div>'
			                         +       '<div class="info">'
			                         +           '￥<span class="price">'+ res.data.proList.listData[i]["price"] +'</span>'
			                         +           '<span class="sales">已团'+ res.data.proList.listData[i]["sales"] +'件</span>'
			                         +       '</div>'
			                         +   '</a></li>';
		                    }
		            		$("#index_page_" + index_page).find('.infinite-scroll-bottom .list-container').append(html);
		            ...
		            // 重置加载flag
		            loading = false;
		            pageCount = res.data.proList.pageCount + 1,
        			pageNow = res.data.proList.pageNow;
