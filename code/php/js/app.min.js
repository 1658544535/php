...
$(function() {
   ...
   //  	});
    ...
    $(document).on("pageInit", "#page-taskList", function(e, pageId, page) {
        ...
        //                 $("#class2,#class3").val("");
        //                 $("#class2,#class3").attr("data-id", '');
        //                 var classTwo = {
        //                     value: [],
        //                     id: []
        //                 };
        //                 var classTowArr = getTwoClass(OneId);
        //                 if(classTowArr.length<=0){
        //                     $("#class2,#class3").hide();
        //                     return false;
        //                 }
        ...
        //                         console.log(classThreeArr)
        //                         if(classThreeArr.length<=0){
        //                             $("#class3").hide();
        //                             return false;
        //                         }
        ...
        //                                 $("#class2").attr("data-id", ThreeId);
        //                             }
        //                         });
        //                         $("#class3").picker("setValue", ['112']);
        //                     }
        //                 });
        //             }
        //         });
