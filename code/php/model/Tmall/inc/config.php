...
/*============================== 网站配置信息  =============================================*/
$dbCharset 	= 'utf8';
$site 	= "http://weixinb2c.taozhuma.com/model/Tmall/";			// 应用地址
// $site 	= "http://weixinb2c/model/Tmall/";			// 应用地址
...
$app_info = array(
	...
	$JSSDKCONFIRE = array(
		...
		'WEBLINK'		=> 'http://weixinm2c.taozhuma.com/activity/shake_new/index.php',
		'WEBDESC'		=> '竹马摇一摇,立即赢大奖！',
	...
	/*============================== 其他参数  =============================================*/
	define('APIURL' ,"http://b2c.taozhuma.com"); 						//api接口的地址
