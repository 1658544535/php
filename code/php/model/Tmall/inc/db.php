<?php
	class Db
	{
		...
		function get_list(  $arrWhere = '', $arrCol = '', $strOrderBy = '', $arrLimit = '' )
		{
			return $this->conn->get_list( $this->table, $arrWhere, $arrCol, $strOrderBy, $arrLimit );
		}
		...
		function getOne( $arrWhere = '', $arrCol = '', $strOrderBy = '' )
		{
