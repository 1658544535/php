...
if(empty($isBuy)){//订单列表进来支付
    $result = apiData('payOrder.do', array('orderNo'=>$orderInfo['orderInfo']['orderNo'],'payMethod'=>$orderInfo['orderInfo']['paymethod'],'uid'=>$userid,'pdkUid'=>$orderInfo['orderInfo']['pdkUid']));
