...
{
  case 'type':
    $ProTypeList = $CategorySettingModel->getAll(array('type'=>1));
...
?>
            <ul>
                    <?php foreach ($TypeList as $type) {?>
                        <li><a href="/product?act=lists&pid=<?php echo $type->type_id; ?>"><img src="<?php echo $site_image?>productType/<?php echo $type->image ;?>" onerror="this.onerror=null;this.src='http://weixinstorenew/res/images/default_big.png'"/><p><?php echo $type->name ;?></p></a></li>
                    <?php }?>
                </ul>
