...
<?php }else{?>
	...
	<iframe id="proInfo" src="<?php echo API_URL;?>/getProductInfoView.do?id=<?php echo $productId?>" frameborder="0" width="100%"></iframe>
	       ...
	       <?php }elseif($ObjGrouponInfo['result']['isJoin']  ==1 && $ObjGrouponInfo['result']['isPublic']  ==1 && $ObjGrouponInfo['result']['isWin']  ==1 && $ObjGrouponInfo['result']['isStart']  ==2  && $ObjGrouponInfo['result']['isRecCoupon'] ==1){?>
	        	<div class="more2">
	                    <a class="btn" href="product_guess_price.php"><span>查看更多</span></a>
	                    <div class="txt" onClick="location.href='order_guess.php?id=<?php echo $gId;?>&pid=<?php echo $productId;?>&cpnno=<?php echo $ObjGrouponInfo['result']['couponNo'] ;?>'"><span>恭喜您获得<?php echo $ObjGrouponInfo['result']['couponPrice'];?>元抵用券，点击马上购买</span></div>
	                </div>
        ...
        <div class="popup popup-guessCoupon">
	        <div>
	            ...
	            <div class="main">
	                ...
	                <a href="order_guess.php?id=<?php echo $gId;?>&pid=<?php echo $productId;?>&cpnno=<?php echo $ObjGrouponInfo['result']['couponNo']?>" class="go">立即前往</a>
	            </div>
