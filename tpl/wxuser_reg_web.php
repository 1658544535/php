...
<body>
    <div class="page-group" id="page-login">
        <div id="page-nav-bar" class="page page-current">
            ...
            <div class="content">
                <form action="wxuser_reg.php" method="post" onsubmit="return tgSubmit()">
                    ...
                    <section class="edit-list-icon">
                        <ul class="list">
							...
							<li>
                                <i class="icon icon-tel"></i>
                                <div class="input-controll"><input type="password" name="password" id="password" class="txt" placeholder="密码" /></div>
                            </li>
							<li>
                                <i class="icon icon-tel"></i>
                                <div class="input-controll"><input type="password" name="repassword" id="repassword" class="txt" placeholder="确认密码" /></div>
                            </li>
