        ...
        <div id="page-nav-bar" class="page page-current">
            ...
            <%if(data["data"].length>0){%>
                <%for(var i=0;i<data["data"].length; i++){%>
                    <li data-isremote="<%=data["data"][i].isRemote%>" data-id="<%=data["data"][i].addId%>" data-name="<%=data["data"][i].name%>" data-tel="<%=data["data"][i].tel%>" data-address="<%=data["data"][i].address%>" data-province="<%=data["data"][i].province%>">
                        <div class="txt">
                            <div class="info">
