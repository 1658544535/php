...
$info = apiData('addPurchase.do', array('activityId'=>$grouponId,'attendId'=>$attendId,'num'=>$num,'skuLinkId'=>$skuId,'pid'=>$productId,'source'=>$activeSource,'invCode'=>$invCode,'uid'=>$userid,'pdkUid'=>$pdkUid));
