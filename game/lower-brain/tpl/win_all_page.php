...
<style>
	*{ margin:0px; padding:0px; }
	...
	@media ( min-width: 380px ) {
		...
		.tip_warp #bg_img{ margin: 0 auto; width:100%; height:650px;  }
		.tip_warp #code_tip_warp img { position:absolute; top:2%; width:20%; right:3%; }
		.tip_warp #btn_warp img{position:absolute; bottom:5%; left:30%; width:40%;}
		.tip_warp .btn_left {  position:absolute; top:75%; left:10%;  width:38%;  }
		.tip_warp .btn_right {  position:absolute; top:75%; right:8%;  width:38%;  }
	}
	...
	@media ( max-width: 380px ) {
		...
		.tip_warp #code_tip_warp img { position:absolute; top:2%; width:25%; right:3%; }
		.tip_warp #btn_warp img{position:absolute; bottom:5%; left:30%; width:40%;}
		.tip_warp .btn_left {  position:absolute; top:75%; left:10%;  width:35%;  }
		.tip_warp .btn_right {  position:absolute; top:75%; right:8%;  width:35%;  }
	}
...
<body>
	<div class="tip_warp">
		<img src="<?php echo $site_game; ?>/images/win_all_bg.png" id="bg_img" />
